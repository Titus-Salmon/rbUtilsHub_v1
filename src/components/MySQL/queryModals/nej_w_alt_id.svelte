...
edi_table JOIN nhcrtTableName nhcrt 
ON edi_table.ediPrefix_upc 
WHERE edi_table.ediPrefix_upc = nhcrt.inv_ScanCode
OR edi_table.ediPrefix_upc = nhcrt.asc_scancode
